...
(function () {
    ...
    function beforeAdd(node, index, item, isInitializing) {
        ...
        $elem = $(node);
        logger.debug('beforeAdd, isInitializing: ' + isInitializing);
    ...
    function beforeRemove(node, index, item) {
        ...
        $elem = $(node);
        logger.debug('beforeRemove, item removed at index ' + $elem.data(indexKey));
    ...
    ko.bindingHandlers.isotope = {
        ...
        'update': function(element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
            ...
            if (!haveInitialized) {
                logger.debug('Binding update called for the first time, initializing Isotope');
                ...
                logger.debug('Updating binding, re-sorting, ' + newElems.length + ' new items');
                // Re-sort elements as their ordering may have changed
                $container.isotope('reSort');
